...
class DeleteGorev extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _DeleteGorevState(selectedGorev!);


  }
  Gorev? selectedGorev = Gorev.withId(id: 0,isim: "",baslangicZamani: 0,bitisZamani: 0,aciklama: "",tamamlandiMi: 0);
  DeleteGorev(Gorev? gorev){
  this.selectedGorev=gorev;
  }

}

class _DeleteGorevState extends State{
  Gorev selectedGorev = Gorev.withId(id: 0,isim: "",baslangicZamani: 0,bitisZamani: 0,aciklama: "",tamamlandiMi: 0);
  _DeleteGorevState(Gorev gorev){
    this.selectedGorev=gorev;
  }
  @override
